...
#define YIN_SAMPLING_RATE 19230

#define YIN_BUFFER_SIZE 512
#define YIN_HALF_BUFFER_SIZE 256
 ...
 */
typedef struct  {
    uint16_t yinBuffer[YIN_HALF_BUFFER_SIZE];		/**< Buffer that stores the results of the intermediate processing steps of the algorithm */
